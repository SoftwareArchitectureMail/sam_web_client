...
=======
var VERSION=new _angular_core.Version("4.4.4"),NgNoValidate=function(){function NgNoValidate(){}return NgNoValidate}();NgNoValidate.decorators=[{type:_angular_core.Directive,args:[{selector:"form:not([ngNoForm]):not([ngNativeValidate])",host:{novalidate:""}}]}],NgNoValidate.ctorParameters=function(){return[]};/**
>>>>>>> Stashed changes
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
